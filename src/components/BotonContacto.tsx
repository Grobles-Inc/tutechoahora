...
export default function BotonContacto() {
  return (
    <div className="btn btn-lg text-[#383838] hover:text-primary bg-white border border-gray-300 transition-all duration-300 hover:scale-110 items-center gap-2 group rounded-full">
      Contáctanos
      <svg
        viewBox="0 0 24 24"
